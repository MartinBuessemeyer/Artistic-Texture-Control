...
class IndexHelper:
    USE_STATIC_INPUT_SIZE_FACTOR = False
    ...
    def input_size_factor(self):
        if IndexHelper.USE_STATIC_INPUT_SIZE_FACTOR:
            static_size = int(409 * IndexHelper.STATIC_SCALE_FACTOR)
            return static_size / 512.0
