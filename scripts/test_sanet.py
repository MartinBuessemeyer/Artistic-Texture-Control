...
if __name__ == '__main__':
    ...
    parser.add_argument('--vgg', type=str, default='./parameter_prediction_network/ast/weights/vgg_normalised.pth')
    parser.add_argument('--decoder', type=str,
                        default='./parameter_prediction_network/ast/weights/decoder_iter_500000.pth')
    parser.add_argument('--transform', type=str,
                        default='./parameter_prediction_network/ast/weights/transformer_iter_500000.pth')
    ...
    def test_transform():
        transform_list = [
            transforms.Resize(size=(1024, 768)),
